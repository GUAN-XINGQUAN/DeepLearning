...
- [Graph Neural Network - Fundamental Practice](./20_graph_neural_network_fundamental_practice.ipynb)
- [Graph Neural Network - Node Embeddings](./21_node_embeddings.ipynb)